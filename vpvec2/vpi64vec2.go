...
func (vec *I64Vec2) MarshalJSON() ([]byte, error) {
	ret, err := json.Marshal([2]int64(*vec))
	if err != nil {
		return nil, vpsys.ErrorChain(err, "unable to marshal I64Vec2")
	}
...
func (vec *I64Vec2) UnmarshalJSON(data []byte) error {
	var tmpArray [2]int64

	err := json.Unmarshal(data, &tmpArray)
	if err != nil {
		return vpsys.ErrorChain(err, "unable to unmarshal I64Vec2")
	}

	*vec = I64Vec2(tmpArray)

	return nil
}

// String returns a readable form of the vector.
func (vec *I64Vec2) String() string {
