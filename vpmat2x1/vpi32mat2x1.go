...
func (mat *I32Mat2x1) ToI64() *I64Mat2x1 {
	var ret I64Mat2x1
...
func (mat *I32Mat2x1) ToX32() *X32Mat2x1 {
	var ret X32Mat2x1
...
func (mat *I32Mat2x1) ToX64() *X64Mat2x1 {
	var ret X64Mat2x1
...
func (mat *I32Mat2x1) ToF32() *F32Mat2x1 {
	var ret F32Mat2x1
...
func (mat *I32Mat2x1) ToF64() *F64Mat2x1 {
	var ret F64Mat2x1
...
func (mat *I32Mat2x1) MarshalJSON() ([]byte, error) {
	...
	if err != nil {
		return nil, vpsys.ErrorChain(err, "unable to marshal I32Mat2x1")
	}
...
func (mat *I32Mat2x1) UnmarshalJSON(data []byte) error {
	...
	if err != nil {
		return vpsys.ErrorChain(err, "unable to unmarshal I32Mat2x1")
	}
...
func (mat *I32Mat2x1) String() string {
...
func (mat *I32Mat2x1) Add(op *I32Mat2x1) *I32Mat2x1 {
	for i, v := range op {
		mat[i] += v
	}
...
// It modifies the matrix, and returns a pointer on it.
func (mat *I32Mat2x1) Sub(op *I32Mat2x1) *I32Mat2x1 {
	for i, v := range op {
		mat[i] -= v
	}
...
// I32Mat2x1Add adds two matrices.
// Args are left untouched, a pointer on a new object is returned.
func I32Mat2x1Add(mata, matb *I32Mat2x1) *I32Mat2x1 {
	var ret = *mata
...
// I32Mat2x1Sub substracts matrix b from matrix a.
// Args are left untouched, a pointer on a new object is returned.
func I32Mat2x1Sub(mata, matb *I32Mat2x1) *I32Mat2x1 {
	var ret = *mata
