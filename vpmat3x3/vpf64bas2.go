...
func F64Bas2New(o, x, y *vpvec2.F64Vec2) *F64Bas2 {
...
func F64Bas2Default() *F64Bas2 {
	return &F64Bas2{*vpvec2.F64Vec2New(vpnumber.F64Const0, vpnumber.F64Const0), *vpvec2.F64Vec2New(vpnumber.F64Const1, vpnumber.F64Const0), *vpvec2.F64Vec2New(vpnumber.F64Const0, vpnumber.F64Const1)}
}

// String returns a readable form of the basis.
func (bas *F64Bas2) String() string {
...
func F64Bas2Normalize(bas *F64Bas2) *F64Bas2 {
	return &F64Bas2{bas.O, *vpvec2.F64Vec2Normalize(&bas.X), *vpvec2.F64Vec2Normalize(&bas.Y)}
}
...
func F64Bas2Ortho(bas *F64Bas2) *F64Bas2 {
	return &F64Bas2{bas.O, bas.X, *vpvec2.F64Vec2New(-bas.X[1], bas.X[0])}
}
