...
type X64Mat4x3 [16]vpnumber.X64

// X64Mat4x3New creates a new matrix containing 4x3 fixed point 64 bit values.
// The column-major (OpenGL notation) mode is used,
// first elements fill first column.
func X64Mat4x3New(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 vpnumber.X64) *X64Mat4x3 {
	return &X64Mat4x3{x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16}
}
...
func (mat *X64Mat4x3) ToI32() *I32Mat4x3 {
	var ret I32Mat4x3
...
func (mat *X64Mat4x3) ToI64() *I64Mat4x3 {
	var ret I64Mat4x3
...
func (mat *X64Mat4x3) ToF64() *F64Mat4x3 {
	var ret F64Mat4x3
...
func (mat *X64Mat4x3) MarshalJSON() ([]byte, error) {
	...
	if err != nil {
		return nil, vpsys.ErrorChain(err, "unable to marshal X64Mat4x3")
	}
...
func (mat *X64Mat4x3) UnmarshalJSON(data []byte) error {
	...
	if err != nil {
		return vpsys.ErrorChain(err, "unable to unmarshal X64Mat4x3")
	}
...
func (mat *X64Mat4x3) String() string {
...
func (mat *X64Mat4x3) Add(op *X64Mat4x3) *X64Mat4x3 {
	for i, v := range op {
		mat[i] += v
	}
...
// It modifies the matrix, and returns a pointer on it.
func (mat *X64Mat4x3) Sub(op *X64Mat4x3) *X64Mat4x3 {
	for i, v := range op {
		mat[i] -= v
	}
...
// It modifies the matrix, and returns a pointer on it.
func (mat *X64Mat4x3) MulScale(factor vpnumber.X64) *X64Mat4x3 {
	for i, v := range mat {
...
// It modifies the matrix, and returns a pointer on it.
func (mat *X64Mat4x3) DivScale(factor vpnumber.X64) *X64Mat4x3 {
	for i, v := range mat {
...
func (mat *X64Mat4x3) IsSimilar(op *X64Mat4x3) bool {
	ret := true
	for i, v := range mat {
...
// It modifies the matrix, and returns a pointer on it.
func (mat *X64Mat4x3) Inv() *X64Mat4x3 {
...
func (mat *X64Mat4x3) MulVecPos(vec *vpvec3.X64Vec3) *vpvec3.X64Vec3 {
...
// within the matrix and then performed at once.
func (mat *X64Mat4x3) MulVecDir(vec *vpvec3.X64Vec3) *vpvec3.X64Vec3 {
	var ret vpvec3.X64Vec3
...
// X64Mat4x3Add adds two matrices.
// Args are left untouched, a pointer on a new object is returned.
func X64Mat4x3Add(mata, matb *X64Mat4x3) *X64Mat4x3 {
	var ret = *mata
...
// X64Mat4x3Sub substracts matrix b from matrix a.
// Args are left untouched, a pointer on a new object is returned.
func X64Mat4x3Sub(mata, matb *X64Mat4x3) *X64Mat4x3 {
	var ret = *mata
...
// X64Mat4x3MulScale multiplies all values of a matrix by a scalar.
// Args are left untouched, a pointer on a new object is returned.
func X64Mat4x3MulScale(mat *X64Mat4x3, factor vpnumber.X64) *X64Mat4x3 {
	var ret = *mat
...
// X64Mat4x3DivScale divides all values of a matrix by a scalar.
// Args are left untouched, a pointer on a new object is returned.
func X64Mat4x3DivScale(mat *X64Mat4x3, factor vpnumber.X64) *X64Mat4x3 {
	var ret = *mat
