...
func F32RebaseOXYZ(Origin, PosX, PosY, PosZ *vpvec3.F32) *F32 {
	return &F32{PosX[0] - Origin[0], PosX[1] - Origin[1], PosX[2] - Origin[2], PosY[0] - Origin[0], PosY[1] - Origin[1], PosY[2] - Origin[2], PosZ[0] - Origin[0], PosZ[1] - Origin[1], PosZ[2] - Origin[2], Origin[0], Origin[1], Origin[2]}
}
