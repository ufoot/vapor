...
// X32 is a matrix containing 4x3 fixed point 32 bit values.
// Can be used in 3D matrix transformations.
type X32 [Size]vpnumber.X32

// X32New creates a new matrix containing 4x3 fixed point 32 bit values.
// The column-major (OpenGL notation) mode is used,
// first elements fill first column.
func X32New(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12 vpnumber.X32) *X32 {
	return &X32{x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12}
}

// X32Identity creates a new identity matrix.
func X32Identity() *X32 {
	return &X32{vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0}
}

// X32Trans creates a new translation matrix.
func X32Trans(vec *vpvec3.X32) *X32 {
	return &X32{vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vec[0], vec[1], vec[2]}
}

// X32Scale creates a new scale matrix.
func X32Scale(vec *vpvec3.X32) *X32 {
	return &X32{vec[0], vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vec[1], vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vec[2], vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0}
}
...
func X32RotX(r vpnumber.X32) *X32 {
	return &X32{vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpmath.X32Cos(r), vpmath.X32Sin(r), vpnumber.X32Const0, -vpmath.X32Sin(r), vpmath.X32Cos(r), vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0}
}
...
func X32RotY(r vpnumber.X32) *X32 {
	return &X32{vpmath.X32Cos(r), vpnumber.X32Const0, -vpmath.X32Sin(r), vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vpmath.X32Sin(r), vpnumber.X32Const0, vpmath.X32Cos(r), vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0}
}
...
func X32RotZ(r vpnumber.X32) *X32 {
	return &X32{vpmath.X32Cos(r), vpmath.X32Sin(r), vpnumber.X32Const0, -vpmath.X32Sin(r), vpmath.X32Cos(r), vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0}
}
...
func X32RebaseOXYZ(Origin, PosX, PosY, PosZ *vpvec3.X32) *X32 {
	return &X32{PosX[0] - Origin[0], PosX[1] - Origin[1], PosX[2] - Origin[2], PosY[0] - Origin[0], PosY[1] - Origin[1], PosY[2] - Origin[2], PosZ[0] - Origin[0], PosZ[1] - Origin[1], PosZ[2] - Origin[2], Origin[0], Origin[1], Origin[2]}
}
...
func X32MulComp(a, b *X32) *X32 {
	...
	for r := 0; r < Height; r++ {
		ret.Set(3, r, vpnumber.X32Mul(a.Get(0, r), b[Col3Row0])+vpnumber.X32Mul(a.Get(1, r), b[Col3Row1])+vpnumber.X32Mul(a.Get(2, r), b[Col3Row2])+a.Get(3, r))
	}
...
func X32Inv(mat *X32) *X32 {
	ret := X32{
		-vpnumber.X32Mul(mat[Col1Row2], mat[Col2Row1]) + vpnumber.X32Mul(mat[Col1Row1], mat[Col2Row2]),
		vpnumber.X32Mul(mat[Col0Row2], mat[Col2Row1]) - vpnumber.X32Mul(mat[Col0Row1], mat[Col2Row2]),
		-vpnumber.X32Mul(mat[Col0Row2], mat[Col1Row1]) + vpnumber.X32Mul(mat[Col0Row1], mat[Col1Row2]),
		vpnumber.X32Mul(mat[Col1Row2], mat[Col2Row0]) - vpnumber.X32Mul(mat[Col1Row0], mat[Col2Row2]),
		-vpnumber.X32Mul(mat[Col0Row2], mat[Col2Row0]) + vpnumber.X32Mul(mat[Col0Row0], mat[Col2Row2]),
		vpnumber.X32Mul(mat[Col0Row2], mat[Col1Row0]) - vpnumber.X32Mul(mat[Col0Row0], mat[Col1Row2]),
		-vpnumber.X32Mul(mat[Col1Row1], mat[Col2Row0]) + vpnumber.X32Mul(mat[Col1Row0], mat[Col2Row1]),
		vpnumber.X32Mul(mat[Col0Row1], mat[Col2Row0]) - vpnumber.X32Mul(mat[Col0Row0], mat[Col2Row1]),
		-vpnumber.X32Mul(mat[Col0Row1], mat[Col1Row0]) + vpnumber.X32Mul(mat[Col0Row0], mat[Col1Row1]),
