...
func X32Identity() *X32 {
	return &X32{vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1}
}

// X32Trans creates a new translation matrix.
func X32Trans(x vpnumber.X32) *X32 {
...
func X32RebaseOX(Origin, PosX vpnumber.X32) *X32 {
	return &X32{PosX - Origin, vpnumber.X32Const0, Origin, vpnumber.X32Const1}
}
...
func (mat *X32) SetRow(row int, vec *vpvec2.X32) {
...
func (mat *X32) GetRow(row int) *vpvec2.X32 {
	var ret vpvec2.X32
...
func (mat *X32) MulVec(vec *vpvec2.X32) *vpvec2.X32 {
	var ret vpvec2.X32
...
func (mat *X32) MulVecPos(vec vpnumber.X32) vpnumber.X32 {
	return vpnumber.X32Div(vpnumber.X32Mul(mat[Col0Row0], vec)+mat[Col1Row0], vpnumber.X32Mul(mat[Col0Row1], vec)+mat[Col1Row1])
}
