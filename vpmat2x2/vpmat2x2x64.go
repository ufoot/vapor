...
// X64 is a matrix containing 2x2 fixed point 64 bit values.
// Can hold the values of a point in a plane.
type X64 [Size]vpnumber.X64

// X64New creates a new matrix containing 2x2 fixed point 64 bit values.
...
func X64Identity() *X64 {
	return &X64{vpnumber.X64Const1, vpnumber.X64Const0, vpnumber.X64Const0, vpnumber.X64Const1}
}

// X64Translation creates a new translation matrix.
func X64Translation(x vpnumber.X64) *X64 {
	return &X64{vpnumber.X64Const1, vpnumber.X64Const0, x, vpnumber.X64Const1}
}

// X64Scale creates a new scale matrix.
func X64Scale(x vpnumber.X64) *X64 {
	return &X64{x, vpnumber.X64Const0, vpnumber.X64Const0, vpnumber.X64Const1}
}
...
func X64RebaseOX(Origin, PosX vpnumber.X64) *X64 {
	return &X64{PosX - Origin, vpnumber.X64Const0, Origin, vpnumber.X64Const1}
}
...
func (mat *X64) MulVec(vec *vpvec2.X64) *vpvec2.X64 {
	var ret vpvec2.X64
