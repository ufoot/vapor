...
func (mat *F64) SetRow(row int, vec *vpvec2.F64) {
...
func (mat *F64) GetRow(row int) *vpvec2.F64 {
	var ret vpvec2.F64
...
func (mat *F64) MulVec(vec *vpvec2.F64) *vpvec2.F64 {
	var ret vpvec2.F64
...
func (mat *F64) MulVecPos(vec float64) float64 {
	return vpnumber.F64Div(mat[Col0Row0]*vec+mat[Col1Row0], mat[Col0Row1]*vec+mat[Col1Row1])
}
