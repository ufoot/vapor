...
func TestI64Mat4JSON(t *testing.T) {
	m1 := I64Mat4Identity()
	var m2 I64Mat4
	...
	if err == nil {
		t.Logf("encoded JSON for I64Mat4 is \"%s\"", string(jsonBuf))
	} else {
		t.Error("unable to encode JSON for I64Mat4")
	}
	err = m2.UnmarshalJSON([]byte("nawak"))
	if err == nil {
		t.Error("able to decode JSON for I64Mat4, but json is not correct")
	}
	err = m2.UnmarshalJSON(jsonBuf)
	if err != nil {
		t.Error("unable to decode JSON for I64Mat4")
	}
	if *m1 != m2 {
