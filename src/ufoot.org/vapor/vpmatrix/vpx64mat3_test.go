...
func TestX64Mat3Math(t *testing.T) {
	...
	m2 = X64Mat3New(x5, x6, x7)
	m3 = X64Mat3Add(m1, m2)
	m4 = X64Mat3New(x1+x5, x2+x6, x3+x7)
	...
	m4 = X64Mat3New(vpnumber.X64Mul(x1, xmul), vpnumber.X64Mul(x2, xmul), vpnumber.X64Mul(x3, xmul))
	if !X64Mat3IsSimilar(m3, m4) {
...
func BenchmarkX64Mat3Add(b *testing.B) {
	mat := X64Mat3New(vpnumber.X64Const1, vpnumber.X64Const1, vpnumber.X64Const1)
