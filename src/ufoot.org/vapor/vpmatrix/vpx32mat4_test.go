...
func TestX32Mat4Math(t *testing.T) {
	...
	m2 = X32Mat4New(x5, x6, x7, x8)
	m3 = X32Mat4Add(m1, m2)
	m4 = X32Mat4New(x1+x5, x2+x6, x3+x7, x4+x8)
	...
	m4 = X32Mat4New(vpnumber.X32Mul(x1, xmul), vpnumber.X32Mul(x2, xmul), vpnumber.X32Mul(x3, xmul), vpnumber.X32Mul(x4, xmul))
	if !X32Mat4IsSimilar(m3, m4) {
...
func BenchmarkX32Mat4Add(b *testing.B) {
	mat := X32Mat4New(vpnumber.X32Const1, vpnumber.X32Const1, vpnumber.X32Const1, vpnumber.X32Const1)
