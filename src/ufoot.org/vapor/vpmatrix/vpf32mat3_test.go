...
func TestF32Mat3Math(t *testing.T) {
	...
	m2 = F32Mat3New(f5, f6, f7)
	m3 = F32Mat3Add(m1, m2)
	m4 = F32Mat3New(f1+f5, f2+f6, f3+f7)
	...
	m4 = F32Mat3New(f1*fmul, f2*fmul, f3*fmul)
	if !F32Mat3IsSimilar(m3, m4) {
...
func BenchmarkF32Mat3Add(b *testing.B) {
	mat := F32Mat3New(vpnumber.F32Const1, vpnumber.F32Const1, vpnumber.F32Const1)
