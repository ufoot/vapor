...
// X64Mat4New creates a new matrix containing 4 fixed point 64 bit values.
func X64Mat4New(x1, x2, x3, x4 vpnumber.X64) *X64Mat4 {
	return &X64Mat4{x1, x2, x3, x4}
}
...
// X64Mat4IsSimilar returns true if matrixs are approximatively the same.
// This is a workarround to ignore rounding errors.
