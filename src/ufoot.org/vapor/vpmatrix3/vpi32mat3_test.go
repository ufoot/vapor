...
func TestI32Mat3JSON(t *testing.T) {
	m1 := I32Mat3Identity()
	var m2 I32Mat3
	...
	if err == nil {
		t.Logf("encoded JSON for I32Mat3 is \"%s\"", string(jsonBuf))
	} else {
		t.Error("unable to encode JSON for I32Mat3")
	}
	err = m2.UnmarshalJSON([]byte("nawak"))
	if err == nil {
		t.Error("able to decode JSON for I32Mat3, but json is not correct")
	}
	err = m2.UnmarshalJSON(jsonBuf)
	if err != nil {
		t.Error("unable to decode JSON for I32Mat3")
	}
	if *m1!= m2 {
