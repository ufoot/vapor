...
func TestX32Math(t *testing.T) {
	...
	v2 = X32New(x5, x6, x7, x8)
	v3 = X32Add(v1, v2)
	v4 = X32New(x1+x5, x2+x6, x3+x7, x4+x8)
	if !v3.IsSimilar(v4) {
		t.Error("Add error")
	}
	...
	v4 = X32New(vpnumber.X32Mul(x1, xmul), vpnumber.X32Mul(x2, xmul), vpnumber.X32Mul(x3, xmul), vpnumber.X32Mul(x4, xmul))
	if !v3.IsSimilar(v4) {
	...
	dot1 := v1.Dot(v2)
	dot2 := vpnumber.X32Mul(x1, x5) + vpnumber.X32Mul(x2, x6) + vpnumber.X32Mul(x3, x7) + vpnumber.X32Mul(x4, x8)
...
func TestX32JSON(t *testing.T) {
	m1 := X32New(vpnumber.I32ToX32(10), vpnumber.I32ToX32(20), vpnumber.I32ToX32(30), vpnumber.I32ToX32(40))
	m2 := X32New(vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0)
...
func BenchmarkX32Add(b *testing.B) {
	vec := X32New(vpnumber.X32Const1, vpnumber.X32Const1, vpnumber.X32Const1, vpnumber.X32Const1)
