...
// X32 is a vector containing 4 fixed point 32 bit values.
...
func X32AxisX() *X32 {
	return &X32{vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0}
}

// X32AxisY returns a new vector representing the Y axis.
func X32AxisY() *X32 {
	return &X32{vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0}
}

// X32AxisZ returns a new vector representing the Z axis.
func X32AxisZ() *X32 {
	return &X32{vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0}
}

// X32FromVec3 creates a new vector from a smaller one,
// by appending a value at its end.
func X32FromVec3(vec *vpvec3.X32, x vpnumber.X32) *X32 {
	return &X32{vec[0], vec[1], vec[2], x}
}

// ToVec3 creates a smaller vector by removing the last value.
func (vec *X32) ToVec3() *vpvec3.X32 {
	return &vpvec3.X32{vec[0], vec[1], vec[2]}
}
