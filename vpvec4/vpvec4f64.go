...
// F64 is a vector containing 4 float64 values.
// Can be used in 3D matrix transformations.
type F64 [Size]float64

// F64New creates a new vector containing 4 float64 values.
...
func F64AxisX() *F64 {
	return &F64{vpnumber.F64Const1, vpnumber.F64Const0, vpnumber.F64Const0, vpnumber.F64Const0}
}

// F64AxisY returns a new vector representing the Y axis.
func F64AxisY() *F64 {
	return &F64{vpnumber.F64Const0, vpnumber.F64Const1, vpnumber.F64Const0, vpnumber.F64Const0}
}

// F64AxisZ returns a new vector representing the Z axis.
func F64AxisZ() *F64 {
	return &F64{vpnumber.F64Const0, vpnumber.F64Const0, vpnumber.F64Const1, vpnumber.F64Const0}
}

// F64FromVec3 creates a new vector from a smaller one,
// by appending a value at its end.
func F64FromVec3(vec *vpvec3.F64, f float64) *F64 {
	return &F64{vec[0], vec[1], vec[2], f}
}

// ToVec3 creates a smaller vector by removing the last value.
func (vec *F64) ToVec3() *vpvec3.F64 {
	return &vpvec3.F64{vec[0], vec[1], vec[2]}
}
