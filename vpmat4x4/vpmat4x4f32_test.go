...
func TestF32Ortho(t *testing.T) {
	const left float32 = -100
	const right float32 = 900
	const bottom float32 = -100
	const top float32 = 900
	const nearVal float32 = -3
	const farVal float32 = -10
	v0 := vpvec3.F32New(left, bottom, nearVal)
	v1 := vpvec3.F32New(right, top, farVal)
	v0OrthoCheck := vpvec3.F32New(-vpnumber.F32Const1, -vpnumber.F32Const1, -vpnumber.F32Const1)
	v1OrthoCheck := vpvec3.F32New(vpnumber.F32Const1, vpnumber.F32Const1, vpnumber.F32Const1)

	mOrtho := F32Ortho(left, right, bottom, top, -nearVal, -farVal)
...
func TestF32Perspective(t *testing.T) {
	const fovy float32 = 45
	const aspect float32 = 1.5
	const zNear float32 = 3
	const zFar float32 = 10
	const xNearCheck float32 = 0.5364919
	const xFarCheck float32 = 0.16094756
	const yNearCheck float32 = 0.8047378
	const yFarCheck float32 = 0.24142134

	v000 := vpvec3.F32New(vpnumber.F32Const0, vpnumber.F32Const0, -zNear)
	v001 := vpvec3.F32New(vpnumber.F32Const0, vpnumber.F32Const0, -zFar)
	v100 := vpvec3.F32New(vpnumber.F32Const1, vpnumber.F32Const0, -zNear)
	v101 := vpvec3.F32New(vpnumber.F32Const1, vpnumber.F32Const0, -zFar)
	v010 := vpvec3.F32New(vpnumber.F32Const0, vpnumber.F32Const1, -zNear)
	v011 := vpvec3.F32New(vpnumber.F32Const0, vpnumber.F32Const1, -zFar)

	v000PerspectiveCheck := vpvec3.F32New(vpnumber.F32Const0, vpnumber.F32Const0, -vpnumber.F32Const1)
	v001PerspectiveCheck := vpvec3.F32New(vpnumber.F32Const0, vpnumber.F32Const0, vpnumber.F32Const1)
	v100PerspectiveCheck := vpvec3.F32New(xNearCheck, vpnumber.F32Const0, -vpnumber.F32Const1)
	v101PerspectiveCheck := vpvec3.F32New(xFarCheck, vpnumber.F32Const0, vpnumber.F32Const1)
	v010PerspectiveCheck := vpvec3.F32New(vpnumber.F32Const0, yNearCheck, -vpnumber.F32Const1)
	v011PerspectiveCheck := vpvec3.F32New(vpnumber.F32Const0, yFarCheck, vpnumber.F32Const1)

	mPerspective := F32Perspective(fovy, aspect, zNear, zFar)
