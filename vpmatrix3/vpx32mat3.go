...
// X32Mat3New creates a new matrix containing 3x3 fixed point 32 bit values.
// The column-major (OpenGL notation) mode is used,
// first elements fill first column.
func X32Mat3New(x1, x2, x3, x4, x5, x6, x7, x8, x9 vpnumber.X32) *X32Mat3 {
	return &X32Mat3{x1, x2, x3, x4, x5, x6, x7, x8, x9}
}

// X32Mat3Identity creates a new identity matrix.
func X32Mat3Identity() *X32Mat3 {
	return &X32Mat3{vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1}
}

// X32Mat3Trans creates a new translation matrix.
func X32Mat3Trans(vec *vpmatrix2.X32Vec2) *X32Mat3 {
	return &X32Mat3{vpnumber.X32Const1, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const0, vpnumber.X32Const1, vpnumber.X32Const0, vec[0], vec[1], vpnumber.X32Const1}
}

// X32Mat3Rot creates a new rotation matrix.
...
func (mat *X32Mat3) MulVecPos(vec *vpmatrix2.X32Vec2) *vpmatrix2.X32Vec2 {
...
// within the matrix and then performed at once.
func (mat *X32Mat3) MulVecDir(vec *vpmatrix2.X32Vec2) *vpmatrix2.X32Vec2 {
	var ret vpmatrix2.X32Vec2
