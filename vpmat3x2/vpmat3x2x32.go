...
// X32 is a matrix containing 3x2 fixed point 32 bit values.
// Can hold the values of a point in space.
type X32 [Size]vpnumber.X32

// X32New creates a new matrix containing 3x2 fixed point 32 bit values.
// The column-major (OpenGL notation) mode is used,
// first elements fill first column.
func X32New(x1, x2, x3, x4, x5, x6 vpnumber.X32) *X32 {
	return &X32{x1, x2, x3, x4, x5, x6}
}
...
func X32Rot(r vpnumber.X32) *X32 {
	return &X32{vpmath.X32Cos(r), vpmath.X32Sin(r), -vpmath.X32Sin(r), vpmath.X32Cos(r), vpnumber.X32Const0, vpnumber.X32Const0}
}
...
func X32RebaseOXY(Origin, PosX, PosY *vpvec2.X32) *X32 {
	return &X32{PosX[0] - Origin[0], PosX[1] - Origin[1], PosY[0] - Origin[0], PosY[1] - Origin[1], Origin[0], Origin[1]}
}
