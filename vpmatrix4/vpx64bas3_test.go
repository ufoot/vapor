...
func TestX64Bas3Math(t *testing.T) {
	o := vpmatrix3.F64Vec3New(1.5, 2.5, 3.5).ToX64()
	x := vpmatrix3.F64Vec3New(1.1, 2.1, 3.1).ToX64()
	y := vpmatrix3.F64Vec3New(1.3, 2.3, 3.3).ToX64()
	z := vpmatrix3.F64Vec3New(1.7, 2.7, 3.7).ToX64()
